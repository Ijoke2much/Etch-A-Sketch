...
function populateBoard(size) {
    ...
    for (let i = 0; i < amount; i++) {
        ...
        // mouseover and mousedown puts the pen up and down to use the cursor
        square.addEventListener("mouseover", printSquares);  
        square.addEventListener("mousedown", printSquares); 
...
// colors the squares with different buttons 
